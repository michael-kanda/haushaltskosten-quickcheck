...
function qc_get_page_url() {
    ...
    /* 2. Auto-Detect: Seite mit [quickcheck] Shortcode suchen */
    global $wpdb;

    /* 2a. Standard: post_content */
    $page = $wpdb->get_row(
    ...
    /* 2b. Page Builder (Breakdance, Elementor, etc.): postmeta durchsuchen */
    if ( ! $page ) {
        $page = $wpdb->get_row(
